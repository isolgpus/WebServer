...
public class ValidatorTest {
    ...
    public void required_failsOnNull() {
        ...
        v.bodyField("name", r -> r.name).required();
    ...
    public void minLength_failsBelowMin() {
        ...
        v.bodyField("name", r -> r.name).minLength(3);
    ...
    public void maxLength_failsAboveMax() {
        ...
        v.bodyField("name", r -> r.name).maxLength(3);
    ...
    public void email_failsWithoutAt() {
        ...
        v.bodyField("email", r -> r.email).email();
    ...
    public void matches_failsOnNonMatch() {
        ...
        v.bodyField("name", r -> r.name).matches("[0-9]+");
    ...
    public void min_failsBelowMin() {
        ...
        v.numericBodyField("age", r -> r.age).min(0);
    ...
    public void max_failsAboveMax() {
        ...
        v.numericBodyField("age", r -> r.age).max(150);
    ...
    public void numericRequired_failsOnNull() {
        Validator<Body> v = validator(new Body(null, null, null, null));
        v.numericBodyField("age", r -> r.age).required();
    ...
    public void multipleRulesOnSameField_accumulateErrors() {
        Validator<Body> v = validator(new Body(null, null, null, null));
        v.bodyField("name", r -> r.name).required();
        v.bodyField("email", r -> r.email).required();
    ...
    @Test
    public void nestedBodyField_prefixesErrorKeys() {
        ...
        v.nestedBodyField("address", r -> r.address, a -> {
            ...
            a.bodyField("zip", x -> x.zip).matches("[0-9]{5}");
        });
    ...
    @Test
    public void nestedBodyField_skipsBlockWhenNull() {
    ...
    @Test
    public void nestedBodyField_passesWhenValid() {
