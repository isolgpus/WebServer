...
public abstract class RouterWrapper {
    ...
    public <T> void handle(final LuxisMapInstruction<HttpErrorResponse> applicationInstruction, final RequestContext vertxContext, final Object applicationState, final Ender ender) {
    ...
    protected <T> void handleAsync(final LuxisMapInstruction<HttpErrorResponse> applicationInstruction, final RequestContext requestContext, final Object applicationState, final Ender ender) {
    ...
    private <T> void processResult(final Result<HttpErrorResponse, T> result, final LuxisMapInstruction<HttpErrorResponse> applicationInstruction, final RequestContext requestContext, final Ender ender) {
